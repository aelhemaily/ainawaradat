...
const firstAyahPrompts = {
    ...
    39: "تَنزِيلُ ٱلْكِتَٰبِ مِنَ ٱللَّهِ ٱلْعَزِيزِ ٱلْحَكِيمِ",
    40: "حمٓ",
    41: "حمٓ",
    42: "حمٓ",
    43: "حمٓ",
    ...
    45: "حمٓ",
    46: "حمٓ",
    47: "ٱلَّذِينَ كَفَرُوا۟ وَصَدُّوا۟ عَن سَبِيلِ ٱللَّهِ أَضَلَّ أَعْمَٰلَهُمْ",
    48: "إِنَّا فَتَحْنَا لَكَ فَتْحًا مُّبِينًا",
    49: "يَٰٓأَيُّهَا ٱلَّذِينَ ءَامَنُو۟ا۟ لَا تُقَدِّسُوا۟ بَيْنَ يَدَىِ ٱللَّهِ وَرَسُولِهِۦ ۖ وَٱتَّقُوا۟ ٱللَّهَ ۚ إِنَّ ٱلَّلَهَ سَمِيعٌ عَلِيمٌ",
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 flex flex-col items-center justify-center p-4 font-inter text-gray-800 relative pb-28"> {/* Changed pb-40 to pb-28 for more content space */}
            ...
            <style>{`
                ...
                @import url('https://fonts.googleapis.com/css2?family=Lateef:wght@400;700&display=swap'); /* Added 700 for potential bolder text */
